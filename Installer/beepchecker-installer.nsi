...
;General
  ...
  InstallDir "$PROGRAMFILES64\The Hello World Writer\BeepChecker"
...
Section
  ...
  WriteRegStr   HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\BeepChecker" "Publisher" "The Hello World Writer"
...
Section "Uninstall"
  ...
  RMDir "$INSTDIR"
  RMDir "$PROGRAMFILES64\The Hello World Writer"
